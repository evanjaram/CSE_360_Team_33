...
public class BusinessDefectsController implements Initializable{
	...
	public ObservableList<DefectLogEntry> getDefects() {
		...
		for (int i = 0; i < Main.businessProject.defectLogs.size(); i++) {
			result.add(Main.businessProject.defectLogs.get(i));
		}
		return result;
	}
}
