...
public class DevelopmentEffortsController implements Initializable {
	@FXML
	...
	public ObservableList<EffortLogEntry> getEfforts() {
		...
		for (int i = 0; i < Main.developmentProject.effortLogs.size(); i++) {
			result.add(Main.developmentProject.effortLogs.get(i));
		}
		return result;
	}
}
